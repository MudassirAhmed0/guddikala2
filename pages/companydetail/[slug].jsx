...
const CompantDetail = ({
  ...
  // useEffect(() => {
  //   axios.get('https://humbletitanapi.herokuapp.com/companydetails/' + symbol.toUpperCase())
  //     .then(res=>{
  //       setProfile(res?.data?.companyProfile?.Item?.Info)
  //       setShares(res?.data?.companyShares?.Item?.Info)
  //       setFinancial(res?.data?.comapnyFinancialRatio?.Item?.Info)
  //       setKeymatrics(res?.data?.comapnyKeymetrics?.Item?.Info)
  //       setRating(res?.data?.comapnyRating?.Item?.Info)
  //       setRealtimequotes(res?.data?.comapnyRealTimeQuote?.Item?.Info)
  //       setFinancialgrowth(res?.data?.comapnyFinancialGrowth?.Item?.Info) 
  //     })
  //   axios.get('https://humbletitanapi.herokuapp.com/competitors/' + symbol.toUpperCase())
